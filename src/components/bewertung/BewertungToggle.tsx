...
export default function BewertungToggle() {
      ...
      {tab === "termin" ? (
        <div>
          ...
          <p className="text-sm text-slate-body mb-6 text-center">
            Wählen Sie einen passenden Termin für Ihre kostenlose Immobilienbewertung.
          </p>
          <CalEmbed
            namespace="immobilienbewertung"
            calLink="homefin-gmbh-zzd9t6/immobilienbewertung"
          />
        </div>
      ) : (
